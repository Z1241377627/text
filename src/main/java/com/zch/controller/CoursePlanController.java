...
import com.zch.po.Course;
import com.zch.po.CoursePlan;
import com.zch.service.CoursePlanService;
import com.zch.service.CourseService;
...
public class CoursePlanController {
	...
	public ModelAndView addCoursePlan(CoursePlan coursePlan, Model model, HttpSession httpSession, @PathVariable(value="tid") String tid) {
		...
		if (coursePlanService.insertCoursePlan(coursePlan) != 0) {
			...
			return new ModelAndView(new RedirectView("/Class-master/TeacherController/managecou/{tid}/1"));
			//return "success";

		} else {
			return new ModelAndView(new RedirectView("/Class-master/fail.jsp"));
		}
